...
- 2.1.3 Software Provisioning [3]
  - Ansible
    ...
    - What is ansible
      ...
      การติดตั้งซอฟต์แวร์หรือแอพพลิเคชัน การตั้งค่าของระบบ การตรวจค่าของระบบ 
      และการเช็คการทำงานของระบบบนเครื่องปลายทางได้หลายเครื่องโดยไม่ต้อง
      ...
      - How Ansible Work
        ...
        ขนาดเล็กไปยังเครื่องปลาบทางเพื่อใช้ในการ run คำสั่งออโตเมชั่นต่าง ๆ และทำการลบออกเมื่อใช้งานเสร็จ
        ```
  - Kubespray
    - What is kubespray
...
- 2.1.5 Site Reliability Engineer (SRE) [16]
    ...
    - What is SRE
      ...
      software engineer ไปปรับใช้กับปัญหาทางด้าน operation
      ```
