...
- 2.1.5 Site Reliability Engineer (SRE) [16]
    ...
    OFF: เป็นการที่เราปิด level ในการแสดงผลของ log ทั้งหมด
    ```
...
- 2.1.6 Key Performance Indicator (KPI) [1]
  ...
  2. Mean Time To Failure (MTTF)
      ...
      ```txt
      คือ ค่าเฉลียก่อนการเสียหายสามารถคำนวณได้จากเวลาที่ระบบสามารถทำงานได้ทั้งหมดหารด้วยจำนวนครั้งที่ระบบหยุดทำงาน
...
8. สามารถนำ metrics ที่เก็บได้จาก Kubernetes และ service ภายในมาแสดงผลผ่าน grafana dashboard ได้อย่างถูกต้องและเหมาะสม
9. สามารถนำ metrics ที่เก็บได้จาก service อื่น ๆ ใน infrastructure เดิมมาแสดงผลผ่าน grafana dashboard ได้อย่างถูกต้องและเหมาะสม
10. สามารถจัดเก็บข้อมูล log ที่ออกมาจาก service ภายใน kubernetes เดิมได้
11. สามารถจัดเก็บข้อมูล log ของ service อื่น ๆ ใน infrastructure เดิมได้
12. สามารถนำ log ที่เก็บได้จาก Kubernetes และ service ภายในมาแสดงผลผ่าน graylog dashboard ได้อย่างถูกต้องและเหมาะสม
13. สามารถนำ log ที่เก็บได้จาก service อื่น ๆ ใน infrastructure เดิมมาแสดงผลผ่าน graylog dashboard ได้อย่างถูกต้องและเหมาะสม
14. สามารถออกแบบระบบ monitoring ให้กับคอนเทนเนอร์แพลตฟอร์มร่วมกับ service เดิมใน infrastructure ที่มีอยู่
15. สามารถออกแบบระบบ alerting ให้กับคอนเทนเนอร์แพลตฟอร์มร่วมกับ service เดิมใน infrastructure ที่มีอยู่
16. สามารถแจ้งเตือนปัญหาที่อาจจะเกิดขึ้นในระบบได้ผ่าน slack
